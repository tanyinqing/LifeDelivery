...
public class MainActivityJpush extends InstrumentedActivity implements OnClickListener{

	private Button mInit;
	private Button mSetting; //高级功能
	...
	public void onClick(View v) {
		...
		case R.id.init:
			...
			break;
		case R.id.setting:
			Intent intent = new Intent(MainActivityJpush.this, PushSetActivity.class);
