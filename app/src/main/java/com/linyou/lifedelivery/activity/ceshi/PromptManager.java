package com.linyou.lifedelivery.activity.ceshi;
		...
		builder.setSingleChoiceItems(items,0,new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				switch (which) {
					case 0:
						dialog.dismiss();
						//Toast.makeText(UserCenterActivity.this, "Toast开", Toast.LENGTH_SHORT).show();
						mPrefUtil.putSetting("isShow3", true);
						mPrefUtil.putSetting("isShow4", false);
						break;
					case 1:
						dialog.dismiss();
						//Toast.makeText(UserCenterActivity.this, "Dialog开", Toast.LENGTH_SHORT).show();
						mPrefUtil.putSetting("isShow3", false);
						mPrefUtil.putSetting("isShow4", true);
						break;
					case 2:
						dialog.dismiss();
						//Toast.makeText(UserCenterActivity.this, "两个全开", Toast.LENGTH_SHORT).show();
						mPrefUtil.putSetting("isShow3", true);
						mPrefUtil.putSetting("isShow4", true);
						break;
					case 3:
